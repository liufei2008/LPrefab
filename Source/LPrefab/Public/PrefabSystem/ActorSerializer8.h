...
namespace LPrefabSystem8
{
	...
	struct FLPrefabOverrideParameterSaveData
	{
	public:
		...
		friend FArchive& operator<<(FArchive& Ar, FLPrefabOverrideParameterSaveData& Data)
		{
			Ar << Data.OverrideParameterData;
			Ar << Data.OverrideParameterNames;
			return Ar;
		}
		friend void operator<<(FStructuredArchive::FSlot Slot, FLPrefabOverrideParameterSaveData& Data)
		{
			FStructuredArchive::FRecord Record = Slot.EnterRecord();
	...
	public:
		...
		TMap<FGuid, FLPrefabOverrideParameterSaveData> MapObjectGuidToSubPrefabOverrideParameter;//override sub prefab's parameter
