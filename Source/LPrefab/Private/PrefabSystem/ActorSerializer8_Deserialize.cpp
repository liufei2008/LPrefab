...
#define LOCTEXT_NAMESPACE "LPrefabSystem8_Deserialize"

namespace LPrefabSystem8
{
...
#define LPREFAB_LOG_DETAIL_TIME 0
...
#if WITH_EDITOR
						if (SubPrefabAsset->PrefabVersion < (uint16)ELPrefabVersion::NewObjectOnNestedPrefab)
						{
