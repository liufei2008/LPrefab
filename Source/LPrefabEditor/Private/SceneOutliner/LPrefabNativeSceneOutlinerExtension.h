...
#include "LPrefabNativeSceneOutlinerExtension.generated.h"
...
class LPREFABEDITOR_API ALPrefabEditorLevelDataStorageActor : public AActor
{
	GENERATED_BODY()
public:
	ALPrefabEditorLevelDataStorageActor()
	{
...
class LPREFABEDITOR_API FLPrefabNativeSceneOutlinerExtension : public FTickableGameObject
{
public:
	FLPrefabNativeSceneOutlinerExtension();
	~FLPrefabNativeSceneOutlinerExtension();
public:
...
private:
	...
	FDelegateHandle OnLPrefabEditorPreserveHierarchyStateChangeDelegateHandle;
	...
	TArray<FName> ExpandedFolderArray;
	ALPrefabEditorLevelDataStorageActor* FindDataStorageActor(bool CreateIfNotExist = true);
};