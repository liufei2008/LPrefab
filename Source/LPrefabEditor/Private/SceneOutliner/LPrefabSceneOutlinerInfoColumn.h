...
{
	class LPREFABEDITOR_API FLPrefabSceneOutlinerInfoColumn : public ISceneOutlinerColumn
	{
	public:
		static TSharedRef<ISceneOutlinerColumn> MakeInstance(ISceneOutliner& SceneOutliner);

		FLPrefabSceneOutlinerInfoColumn(ISceneOutliner& InSceneOutliner);

		virtual ~FLPrefabSceneOutlinerInfoColumn();
