...
#define LOCTEXT_NAMESPACE "LPrefabEditorUtils"

TMap<FString, UTexture2D*> LPrefabEditorUtils::TexturePathToTextureMap;
UTexture2D* LPrefabEditorUtils::LoadTexture(const FString& TextureFullPath)
{
...
void LPrefabEditorUtils::DrawThumbnailIcon(const FString& TextureFullPath, int32 X, int32 Y, uint32 Width, uint32 Height, FCanvas* Canvas)
{
