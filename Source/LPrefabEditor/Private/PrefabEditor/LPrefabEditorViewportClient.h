...
class FLPrefabEditorViewportClient : public FEditorViewportClient
{
public:
	FLPrefabEditorViewportClient(FLPrefabEditorScene& InPreviewScene, TWeakPtr<FLPrefabEditor> InPrefabEditorPtr, const TSharedRef<class SLPrefabEditorViewport>& InEditorViewportPtr);

	virtual ~FLPrefabEditorViewportClient();
	...
	FLPrefabEditorScene* PrefabScene = nullptr;
...
private:
	...
	ULPrefab* GetPrefabBeingEdited()const;
	/**
